          ...
          prev.map((visitor) =>
            visitor.id === link.visitorId
              ? {
                  ...
                  cpf: draft.cpf ?? visitor.cpf,
                  company: draft.company ?? visitor.company,
                  role: draft.role ?? visitor.role,
                  nationality: draft.nationality ?? visitor.nationality,
                  sex: draft.sex ?? visitor.sex,
                  birthDate: draft.birthDate ?? visitor.birthDate,
                  phone: draft.phone ?? visitor.phone,
                  email: draft.email ?? visitor.email,
                  emergencyPhone: draft.emergencyPhone ?? visitor.emergencyPhone,
                  neighborhood: draft.neighborhood ?? visitor.neighborhood,
                  weightKg: draft.weightKg ?? visitor.weightKg,
                  shoeSize: draft.shoeSize ?? visitor.shoeSize,
                  shirtSize: draft.shirtSize ?? visitor.shirtSize,
                  dietaryHasRestriction:
                    draft.dietaryHasRestriction ?? visitor.dietaryHasRestriction,
                  dietaryRestriction:
                  ...
                  mobilityNotes: draft.mobilityNotes ?? visitor.mobilityNotes,
                  comorbidity: draft.comorbidity ?? visitor.comorbidity,
                  comorbidityNotes: draft.comorbidityNotes ?? visitor.comorbidityNotes,
                  specialAttention: draft.specialAttention ?? visitor.specialAttention,
                  specialAttentionNotes:
                    draft.specialAttentionNotes ?? visitor.specialAttentionNotes,
                  fliesByAir: draft.fliesByAir ?? visitor.fliesByAir,
                  hasFlightData: draft.hasFlightData ?? visitor.hasFlightData,
                  arrivalFlight: draft.arrivalFlight ?? visitor.arrivalFlight,
                  departureFlight: draft.departureFlight ?? visitor.departureFlight,
                  hotelName: draft.hotelName ?? visitor.hotelName,
                  whatsapp: draft.whatsapp ?? visitor.whatsapp,
                  lgpdConsent: draft.lgpdConsent ?? visitor.lgpdConsent,
                  lgpdConsentAt: draft.lgpdConsentAt ?? visitor.lgpdConsentAt,
                }
              : visitor,
          ),
        )
